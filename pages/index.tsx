        ...
        <div className={styles.buttons}>
          <Link href="/guildhall" passHref className={styles.button}>
            ...
            <div className={styles.icon_box}>
              <p className={styles.icon_text}>Guildhall</p>
            </div>
          </Link>
          ...
          <Link href="/bank" passHref className={styles.button}>
            <div className={styles.button}>
              ...
              <div className={styles.icon_box}>
                <p className={styles.icon_text}>Bank</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/market" passHref className={styles.button}>
            <div className={styles.button}>
              ...
              <div className={styles.icon_box}>
                <p className={styles.icon_text}>Market</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/council" passHref className={styles.button}>
            <div className={styles.button}>
              ...
              <div className={styles.icon_box}>
                <p className={styles.icon_text}>Council</p>
              </div>
            </div>
          </Link>
        </div>
