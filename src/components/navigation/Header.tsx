...
import { useAccount, useNetwork, useStarkName } from "@starknet-react/core";
import { useGuild } from "../../context/GuildContext";
import { displayAddress } from "../../utils/address";
import { sounds } from "../../shared/sounds";
import { useSound } from "../../context/SoundContext";
import { PowerIcon, ShieldIcon, MenuIcon } from "../../shared/icons";
...
export const Header = () => {
  ...
  const navStyle = (page: string) => {
    return isBasePage(page)
      ? [styles.link_container, styles.highlighted].join(" ")
        ...
        <div className={styles.navbar}>
          ...
          <div className={styles.network_links}>
            ...
            <div ref={connectMenuRef}>
              {address ? (
                <>
                  ...
                  >
                    <p>
                      {chain?.id == BigInt("0x534e5f474f45524c49")
                        ? data
                          ? data
            ...
            <div
              className={
                isMobileMenuOpen
                  ? [styles.mobile_menu_container, styles.open].join(" ")
            ...
            <div className={styles.music_area}>
              <div
                className={styles.music_button_1}
                onClick={() => {
                  playClickSound();
                  toggleSound();
                }}
