  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.left_align}>Account</div>
        <div className={styles.left_align}>Guilds</div>
        <div className={styles.right_align}>Games</div>
        <div className={styles.right_align}>Items</div>
      </div>
      {/* <div className={styles.dividor} /> */}
      <div className={styles.account_contents}>
        {accounts.map((account, index) => (
          ...
          >
            <div className={styles.account_row} key={index}>
